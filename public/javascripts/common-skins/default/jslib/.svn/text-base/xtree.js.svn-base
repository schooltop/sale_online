...
var imgplus="/"+rootPath+"/images/xtreeicon/collapse.gif";
var imgminus="/"+rootPath+"/images/xtreeicon/expand.gif";
var imgleaf="/"+rootPath+"/images/xtreeicon/leaf.gif";
...
function reportParseError(errObj)//��������������
{
	var s = "";
...
function reportRuntimeError(errObj)//��������������
{
...
function FinishSave()
{
	...
	{	
		...
		{
			var returnXml= "<return><returnInfo result='0' errInfo='xmlhttp����" + xmlHttp.status + " " + xmlHttp.statusText.replace(/\\'/g, "\'") + "'/><treeInfo/></return>"	
		} 
		else 
		{	
