...
////      	 chart.amChart.Adapter.superclass.onAfterMedia.call(this);
//      	 alert(this.pollReadyState(this));
//      	 alert(this);
//      	alert(this.mediaObject);
////      	 alert(this.getSWFObject);
////      	 this.fireEvent('processcompleted',this.onProcesscompleted);
//      },
      
      
      
//      onProcesscompleted : function(){
//      	alert('onProcesscompleted');
//      }
//      ,
       ...
       * @default true
       */
       appendChartData : function(data, immediate,removeCount){
           var o;
